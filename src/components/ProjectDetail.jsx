...
import { projects as staticProjects, profile } from "../data/portfolio";
...
const ProjectDetails = () => {
  ...
  useEffect(() => {
    window.scrollTo(0, 0);
    const selectedProject = staticProjects.find(
  ...
  const projectUrl = `${profile.website}/project/${toSlug(project.Title)}`;
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          ...
          content={
            project.Description
              ...
              : `Project ${project.Title} by ${profile.name} — ${profile.role}.`
          }
        />
        ...
        <meta
          property="og:title"
          content={`${project.Title} — ${profile.name}`}
        />
        <meta
            ...
            <div className="grid lg:grid-cols-2 gap-8 md:gap-16">
                ...
                <div className="flex flex-wrap gap-3 md:gap-4">
                  {project.Play && (
                    ...
                    >
                      ...
                      <PlayCircle className="relative w-4 h-4 md:w-5 md:h-5 group-hover:rotate-12 transition-transform" />
                      <span className="relative font-medium">Google Play</span>
                    </a>
                  )}
                  ...
                  {project.Github && (
                    ...
                    >
                      ...
                      <span className="relative font-medium">
                        {project.Github === "Private" ? "Private" : "Github"}
                      </span>
                    </a>
                  )}
                </div>
              ...
              <div className="space-y-6 md:space-y-10 animate-slideInRight">
                <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-2xl group bg-white/5">
                  ...
                  {project.Logo ? (
                    <div className="flex items-center justify-center w-full aspect-square p-10 sm:p-14 lg:p-16">
                      <img
                        src={project.Logo}
