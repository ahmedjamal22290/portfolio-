...
import { profile, projects, certificates, skills, asset } from "../data/portfolio"
...
const AboutPage = () => {
  // Static stats computed from the portfolio data file
  ...
  useEffect(() => {
    const startDate = new Date(profile.experienceStartYear);
    ...
    >
        ...
        <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
          &ldquo;{profile.quote}&rdquo;
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href={profile.resume} download className="w-full lg:w-auto">
              <button 
                data-aos="fade-up"
                data-aos-duration="800"
      ...
      <div className="w-full mx-auto pt-16 sm:pt-24">
        <div className="text-center mb-10">
          <h2 className="text-3xl md:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#6366f1] to-[#a855f7]" data-aos="zoom-in-up" data-aos-duration="600">
            Skills
          </h2>
          <p className="mt-2 text-gray-400 max-w-2xl mx-auto text-base sm:text-lg" data-aos="zoom-in-up" data-aos-duration="800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-6">
          {skills.map((skill, index) => (
            <div
              ...
              className="relative group bg-gray-900/50 backdrop-blur-lg rounded-2xl p-5 md:p-6 border border-white/10 overflow-hidden transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl hover:border-[#a855f7]/40"
            >
              ...
              <h3 className="text-sm md:text-base uppercase tracking-wider text-[#a855f7] font-semibold mb-2">
                {skill.label}
              </h3>
