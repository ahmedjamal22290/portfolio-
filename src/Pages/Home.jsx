...
const TECH_STACK = profile.heroTech;
const SOCIAL_LINKS = [
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Official portfolio of Ahmed Jamal, Flutter Developer. I focus on building cross-platform mobile applications with clean architecture and delightful user experiences." />
     <meta name="robots" content="index, follow" />
        <link rel="canonical" href={profile.website} />
        <meta property="og:title" content={`${profile.name} — ${profile.role}`} />
     <meta property="og:description" content="Official portfolio of Ahmed Jamal, Flutter Developer." />
              ...
              <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
                ...
                <div className="space-y-4 sm:space-y-6">
                  ...
                  <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                    data-aos="fade-up"
                    data-aos-delay="1000">
                    Building cross-platform mobile apps that are innovative, functional, and user-friendly.
                  </p>
